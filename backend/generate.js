...
app.post('/generate-certificate', async (req, res) => {
  try {
    ...
    const participationText = 'has participated in the IEEE WIE Day Workshop on June 19, 2025';
    const participationWidth = font.widthOfTextAtSize(participationText, fontSize);
    ...
    res.set({
      ...
      'Content-Disposition': `attachment; filename=${encodeURIComponent(nameText)}_certificate.pdf`,
