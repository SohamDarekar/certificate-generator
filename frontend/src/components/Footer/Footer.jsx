          ...
          <div className="footer__main">
            <div className="footer__brand">
              ...
              <p className="footer__brand-description">
                Advancing technology for humanity through engineering excellence, innovation, and professional development.
              </p>
            </div>
            ...
            <div className="footer__links">
              ...
              <div className="footer__section">
                ...
                <ul className="footer__link-list">
                  <li>
                    <a 
                      href="https://www.instagram.com/ieee.vsit/?hl=en" 
                      target="_blank" 
                      rel="noopener noreferrer"
                  ...
                  <li>
                    <a 
                      href="https://www.instagram.com/wieieeevsit/" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="footer__link footer__social-link"
                    >
                  ...
                  <li>
                    <a 
                      href="https://www.linkedin.com/company/ieeevsit/?viewAsMember=true" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="footer__link footer__social-link"
                    >
